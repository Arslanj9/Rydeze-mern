  ...
  return (
    <div className="w-full mb-3 shadow-md rounded-lg flex items-center overflow-hidden border border-gray-100 border-opacity-30 bg-opacity-30">
      <div className="flex flex-row shadow-sm w-full">
        <div className="flex flex-col justify-center basis-2/3 p-2 flex-grow">
          <div className="flex gap-2 mb-1 sm:gap-3">

            {profilePic ?
              <img className="w-10 h-10 rounded-full sm:w-12 sm:h-12" src={`${apiUrl}${profilePic}`} alt={`${name} profile`} />
              :
              <img className="w-10 h-10 rounded-full sm:w-12 sm:h-12" src={"./assets/icons/person-icon.png"} alt={`${name} profile`} />
            }
          ...
          <div className="ml-6">
            <h1 className="text-lg sm:text-sm mt-2">
