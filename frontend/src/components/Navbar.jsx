        ...
        <nav className="relative z-50 top-auto left-auto w-auto sm:relative sm:top-0 sm:left-0 sm:w-full sm:z-50 bg-[#13162e] text-white px-4 py-4">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden sm:flex sm:items-center gap-8">
                    ...
                    <div className="pointer-events-none text-center">
                        ...
                        <h1 className="text-gray-500 text-xs">My Listings</h1>
                    </div>
                ...
                {/* Mobile Menu Icon */}
                <div className="sm:hidden flex justify-between w-full items-center" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                    <h2 className="text-xl ml-2">ryd
            ...
            {isDropdownOpen && (
                <div className="absolute top-full left-0 w-full rounded-lg bg-[#292d49]">
                    ...
                    {/* Profile Icon */}
                    <a href="/profile" className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white bg-transparent">
                        <span className="material-symbols-outlined text-2xl hover:text-zinc-400 bg-transparent">
                            person
                        </span>
                        <h1 className="text-gray-200 text-lg bg-transparent">Profile</h1>
                    </a>


                    {userRole === "commuter" ?
                        <a href="/" className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white bg-transparent">
                            <span className="material-symbols-outlined text-2xl hover:text-zinc-400 bg-transparent">
                                airport_shuttle
                            </span>
                            <h1 className="text-gray-200 text-lg bg-transparent">Hosts</h1>
                        </a> :
                        <a href="/" className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white bg-transparent">
                            <span className="material-symbols-outlined text-2xl hover:text-zinc-400 bg-transparent">
                                escalator_warning
                            </span>
                            <h1 className="text-gray-200 text-lg bg-transparent">Commuters</h1>
                        </a>
                    }


                    {/* Publish Icon */}
                    <a href="/publish" className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white bg-transparent">
                        <span className="material-symbols-outlined text-2xl hover:text-zinc-400 bg-transparent">
                            add_circle
                        </span>
                        <h1 className="text-gray-200 text-lg bg-transparent">Publish</h1>
                    </a>
                    ...
                    <div className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white pointer-events-none bg-transparent">
                        ...
                        <h1 className="text-lg text-gray-500 bg-transparent">My Listings</h1>
                    </div>
                    ...
                    <div className="flex gap-3 items-center py-3 px-4 hover:bg-gray-700 text-white pointer-events-none bg-transparent">
                        ...
                        <h1 className="text-lg text-gray-500 bg-transparent">Inbox</h1>
                    </div>


                    <div className="flex px-12 mt-6 bg-[#13162e] mb-6 z-50 bg-transparent">
                        <a href="/login" onClick={handleLogout} className="text-white px-6 py-2 border bg-transparent border-gray-300 rounded-lg w-full text-center hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 z-50">
                            Logout
                        </a>
                    </div>
                </div>
